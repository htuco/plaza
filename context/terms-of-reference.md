...
| 2026-08-21 | `design_handoff_*/` is excluded from ESLint | The bundled design-system JS is reference material, not app code, and made `pnpm lint` unusable (22 errors / 163 warnings) |
