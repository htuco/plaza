...
5. Execute the research using appropriate tools:
   - Read files (Drizzle schema in lib/db/, constants, components)
   - Query the Supabase Postgres database if needed
...
- Output goes to `context/research/` unless the prompt file specifies otherwise
