...
> **REFERENCE ONLY — not the active skill.** The live skill is `SKILL.md` +
> `actions/`. This file is the kit's single-file packaging, kept for reference,
> and it still describes the kit's default merge-to-`main` flow. This repo never
> merges locally — see `actions/complete.md` and `context/git-workflow.md`.
