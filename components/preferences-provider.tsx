...
const translations: Record<LanguagePreference, Record<string, TranslationEntry>> = {
  en: {
    ...
    "higherLower.streak": (count) => `Streak · ${count} correct`,
    "higherLower.categoryLabel": (name) => `Category: ${name}`,
  ...
  bs: {
    ...
    "higherLower.streak": (count) => `Niz · ${count} tačnih`,
    "higherLower.categoryLabel": (name) => `Kategorija: ${name}`,
