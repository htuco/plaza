...
const translations: Record<LanguagePreference, Record<string, TranslationEntry>> = {
  en: {
    ...
    "table.rollDie": "Roll the die",
    "table.rolled": (value) => `Rolled a ${value}`,
    "table.revealCard": "Flip a card",
    "table.deckHint": "Flip a card to pick tonight's game",
    ...
    "imposteri.tapToReveal": "Tap to flip your card",
    "imposteri.tapToHide": "Tap the card to hide it again",
    "imposteri.roleHidden": "Face down",
    ...
    "share.button": "Share",
    "share.qrButton": "Generate QR",
    "share.title": "Invite your crew",
    "share.subtitle": "Send the link or let them scan the code.",
    "share.qrTitle": "Scan to join",
    "share.qrSubtitle": "Point a camera at the code.",
    "share.close": "Close",
    "share.copy": "Copy",
    "share.copied": "Copied!",
    "share.shareVia": "Open share sheet",
    "share.scanHint": "Scan to join — just pick a name.",
    "share.qrAlt": (code) => `QR code to join room ${code}`,
    "share.text": (code) => `Join my room ${code} on Plaza`,
    "join.heading": "Join the room",
    "join.invited": "You've been invited — pick a name to take a seat.",
    "join.cta": "Take a seat",
    ...
    "song.countdownTitle": "Get ready",
    "song.playingTitle": "Listen & guess",
    "song.roundEndTitle": "Round result",
    "song.finishedTitle": "Final result",
    "song.source": "Music source",
    "song.customQuery": "…or type an artist",
    "song.customQueryPlaceholder": "e.g. Dino Merlin",
    "song.rounds": "Rounds",
    "song.roundTime": "Round time",
    "song.clipLength": "Clip length",
    "song.clipLengthHint": "Shorter clip, harder round — and every point is worth more. Picking one also retunes the round time.",
    "song.replay": "Replay",
    "song.volume": "Volume",
    ...
    "song.unlockAudio": "Tap to enable music for this game",
    "song.unlockAudioHint": "Tap the banner above so music can autoplay",
    "song.tapToPlay": "Tap to play",
    "song.getReady": "Get ready…",
    "song.autoNextRound": "Next round starts automatically…",
    "song.autoResults": "Final results coming up…",
    "gradovi.filled": (filled, total) => `${filled}/${total} filled`,
    "gradovi.winner": "Winner",
    "room.exit": "Exit",
    "lobby.playersCount": (count) => `Players · ${count}`,
    "lobby.minPlayersFor": (count, game) => `min. ${count} for ${game}`,
    "lobby.startNamed": (game) => `Start ${game}`,
    "lobby.readyNote": (count) => `${count} in the room · everyone's ready`,
    "lobby.hostPicking": "Host is picking a game…",
    "lobby.gameSelected": (game) => `${game} is selected`,
    "lobby.noGameYet": "No game picked yet",
    "lobby.waitingHostStart": "Waiting for the host to start the round…",
    "join.invitedShort": "You've been invited to this room",
    "join.nicknameHelper": "Visible to everyone in the room · max 20 characters",
    "game.roundLength": "~5 min per round",
    "share.qrShort": "QR",
    "share.inviteTitle": "Invite the crew",
    "share.inviteSubtitle": "Scan at the table or send the link",
    "share.shareViaCta": "Share via…",
    "notFound.emptyTitle": "This room is empty",
    "notFound.emptyBody":
      "The code expired or the host closed the room. Start a new one and send the crew a fresh QR.",
    "notFound.createRoom": "Start a new room",
    "notFound.enterCode": "Enter a different code",
    "imposteri.tapHideNote":
      "The card is face-down — tap it again to hide it from anyone looking over your shoulder.",
    "imposteri.hostPacingNote": (count) => `The host sets the pace · ${count} in this round`,
    "imposteri.voteNow": "Vote now",
    "imposteri.voteSecret": "Nobody else sees your vote",
    "imposteri.yourVote": "your vote",
    "imposteri.noMajorityNote": "If nobody gets a majority, the impostor walks.",
    "imposteri.result.caught": "Impostor caught",
    "imposteri.result.escaped": "Impostor walked",
    "imposteri.ejectedWithVotes": (name, votes, total) =>
      `${name} was ejected — ${votes} of ${total} votes.`,
    "imposteri.sessionNote": (round) =>
      `Round ${round} · the session stays open until the host closes the room`,
    "imposteri.backToLobby": "Send everyone back to the lobby",
    "alias.youExplain": "You're explaining",
    "alias.teamExplains": "Your team is explaining",
    "alias.otherTeamExplains": "The other team is explaining",
    "alias.explainLabel": "Explain",
    "alias.wordRule": "No word roots, no gestures",
    "alias.noPenalty": "no penalty",
    "alias.penalty": "−1 point",
    "alias.turnTally": (correct, skipped) =>
      `This turn: ${correct} correct · ${skipped} skipped`,
    "alias.wordsLeft": (count) => `${count} words left`,
    "gradovi.roundLetter": (round, total) => `Round ${round} / ${total} · letter`,
    "gradovi.fillCategories": (count) => `Fill in ${count} categories`,
    "gradovi.playersDone": (count, total) => `${count} of ${total} players are done`,
    "gradovi.doneStop": "I'm done — stop",
    "gradovi.stopNote": "Stopping locks your answers and speeds the round up",
    "asocijacije.boardEyebrow": (round) => `Board ${round} · open a field`,
    "asocijacije.subtitle": "Open fewer fields — score more",
    "asocijacije.yourScore": (points) => `You ${points}`,
    "asocijacije.finalWithPoints": (points) => `Final solution · ${points} points`,
    "asocijacije.hostRevealNote": "The host can open the board",
    "asocijacije.columns": "Columns",
    "song.clipLabel": (seconds) => `clip ${seconds}s`,
    "song.titleMatched": "Title matched",
    "song.titlePending": "Title — not yet",
    "song.artistMatched": "Artist matched",
    "song.artistPending": "Artist — not yet",
    "song.firstCorrect": (name, bonus) => `First correct: ${name} +${bonus}`,
    "song.noFirstYet": "Nobody has it yet",
    "higherLower.phase.setup": "Setup",
    "higherLower.phase.guessing": "Guess",
    "higherLower.phase.reveal": "Reveal",
    "higherLower.phase.finished": "Finished",
    "higherLower.category.miks": "Mix",
    "higherLower.category.poznati": "Famous people",
    "higherLower.category.sport": "Sport",
    "higherLower.category.film-muzika": "Film & music",
    "higherLower.category.hrana": "Food & drink",
    "higherLower.category.brendovi-tech": "Brands & tech",
    "higherLower.category.mjesta": "Places",
    "higherLower.category.historija-pojmovi": "History",
    "higherLower.category.regional": "Regional",
    "higherLower.setupTitle": "Higher or Lower",
    "higherLower.playingTitle": "What gets googled more?",
    "higherLower.finishedTitle": "Game over",
    "higherLower.rulesHint": "Everything is compared on one number: average monthly Google searches. Everyone guesses the same item at the same time — right answers score, wrong ones cost a life.",
    "higherLower.settings.category": "Category",
    "higherLower.settings.rounds": "Rounds",
    "higherLower.settings.lives": "Lives",
    "higherLower.settings.timer": "Time per guess",
    "higherLower.startGame": "Start game",
    "higherLower.waitingForSetup": "Waiting for the host to start...",
    "higherLower.searches": "monthly searches",
    "higherLower.hidden": "? ? ?",
    "higherLower.question": (label) => `Does ${label} get more or fewer searches?`,
    "higherLower.higher": "Higher",
    "higherLower.lower": "Lower",
    "higherLower.round": (round, total) => `Round ${round} / ${total}`,
    "higherLower.lockedIn": "Locked in — waiting for the others",
    "higherLower.youAreOut": "You're out of lives — watching the rest",
    "higherLower.spectating": "You joined mid-game — you'll play next time",
    "higherLower.correct": "Correct!",
    "higherLower.wrong": "Wrong!",
    "higherLower.noAnswer": "Too slow!",
    "higherLower.points": (points) => `+${points}`,
    "higherLower.answered": "answered",
    "higherLower.out": "out",
    "higherLower.next": "Next",
    "higherLower.seeResults": "Results",
    "higherLower.scoreboard": "Scoreboard",
    "higherLower.winner": "Winner",
    "higherLower.tie": "Tie!",
    "higherLower.streak": (count) => `${count} in a row`,
    "higherLower.bestStreak": (count) => `best streak ${count}`,
    "higherLower.playAgain": "Play again",
  ...
  bs: {
    ...
    "table.rollDie": "Baci kockicu",
    "table.rolled": (value) => `Palo je ${value}`,
    "table.revealCard": "Okreni kartu",
    "table.deckHint": "Okreni kartu i izaberi igru večeri",
    ...
    "imposteri.tapToReveal": "Tapni da okreneš svoju kartu",
    "imposteri.tapToHide": "Tapni kartu da je opet sakriješ",
    "imposteri.roleHidden": "Okrenuta",
    ...
    "share.qrButton": "Generiši QR",
    "share.title": "Pozovi raju",
    "share.subtitle": "Pošalji link ili neka skeniraju kod.",
    "share.qrTitle": "Skeniraj da uđeš",
    "share.qrSubtitle": "Uperi kameru u kod.",
    "share.close": "Zatvori",
    "share.copy": "Kopiraj",
    "share.copied": "Kopirano!",
    "share.shareVia": "Otvori share meni",
    "share.scanHint": "Skeniraj da uđeš — samo upiši ime.",
    "share.qrAlt": (code) => `QR kod za ulazak u sobu ${code}`,
    "share.text": (code) => `Uđi u moju sobu ${code} na Plaza`,
    "join.heading": "Uđi u sobu",
    "join.invited": "Pozvan si — upiši ime i sjedni za sto.",
    "join.cta": "Sjedni za sto",
    ...
    "song.customQuery": "…ili upiši izvođača",
    "song.customQueryPlaceholder": "npr. Dino Merlin",
    "song.rounds": "Runde",
    "song.roundTime": "Vrijeme runde",
    "song.clipLength": "Dužina isječka",
    "song.clipLengthHint": "Kraći isječak, teža runda — i svaki poen vrijedi više. Odabir odmah podesi i vrijeme runde.",
    "song.replay": "Pusti ponovo",
    "song.volume": "Jačina",
    ...
    "song.unlockAudio": "Dodirni da uključiš muziku za ovu igru",
    "song.unlockAudioHint": "Dodirni traku iznad da muzika može sama krenuti",
    "song.tapToPlay": "Dodirni za pjesmu",
    "song.getReady": "Priprema…",
    "song.autoNextRound": "Sljedeća runda kreće automatski…",
    "song.autoResults": "Konačni rezultat stiže…",
    "gradovi.filled": (filled, total) => `${filled}/${total} popunjeno`,
    "gradovi.winner": "Pobjednik",
    "room.exit": "Izađi",
    "lobby.playersCount": (count) => `Igrači · ${count}`,
    "lobby.minPlayersFor": (count, game) => `min. ${count} za ${game}`,
    "lobby.startNamed": (game) => `Počni ${game}`,
    "lobby.readyNote": (count) => `${count} igrača u sobi · svi su spremni`,
    "lobby.hostPicking": "Host bira igru…",
    "lobby.gameSelected": (game) => `${game} je izabran`,
    "lobby.noGameYet": "Igra još nije izabrana",
    "lobby.waitingHostStart": "Čeka se da host započne rundu…",
    "join.invitedShort": "Pozvan si u ovu sobu",
    "join.nicknameHelper": "Vidljiv svima u sobi · max 20 znakova",
    "game.roundLength": "~5 min po rundi",
    "share.qrShort": "QR",
    "share.inviteTitle": "Pozovi ekipu",
    "share.inviteSubtitle": "Skeniraj za stolom ili pošalji link",
    "share.shareViaCta": "Podijeli preko…",
    "notFound.emptyTitle": "Ova soba je prazna",
    "notFound.emptyBody":
      "Kod je istekao ili je host zatvorio sobu. Napravi novu i pošalji ekipi novi QR.",
    "notFound.createRoom": "Napravi novu sobu",
    "notFound.enterCode": "Unesi drugi kod",
    "imposteri.tapHideNote":
      "Karta je licem nadolje — tapni ponovo da je sakriješ od pogleda sa strane.",
    "imposteri.hostPacingNote": (count) => `Host kontroliše tempo · ${count} igrača u rundi`,
    "imposteri.voteNow": "Glasajte sada",
    "imposteri.voteSecret": "Tvoj glas drugi ne vide",
    "imposteri.yourVote": "tvoj glas",
    "imposteri.noMajorityNote": "Ako niko ne dobije većinu, impostor prolazi.",
    "imposteri.result.caught": "Impostor uhvaćen",
    "imposteri.result.escaped": "Impostor je prošao",
    "imposteri.ejectedWithVotes": (name, votes, total) =>
      `Izbačen je ${name} — ${votes} od ${total} glasa.`,
    "imposteri.sessionNote": (round) =>
      `Runda ${round} · sesija ostaje otvorena dok host ne zatvori sobu`,
    "imposteri.backToLobby": "Vrati sve u lobby",
    "alias.youExplain": "Ti objašnjavaš",
    "alias.teamExplains": "Tvoj tim objašnjava",
    "alias.otherTeamExplains": "Drugi tim objašnjava",
    "alias.explainLabel": "Objasni",
    "alias.wordRule": "Bez korijena riječi i bez gestikulacije",
    "alias.noPenalty": "bez kazne",
    "alias.penalty": "−1 bod",
    "alias.turnTally": (correct, skipped) =>
      `U ovom potezu: ${correct} tačno · ${skipped} preskočeno`,
    "alias.wordsLeft": (count) => `ostalo ${count} riječi`,
    "gradovi.roundLetter": (round, total) => `Runda ${round} / ${total} · slovo`,
    "gradovi.fillCategories": (count) => `Popuni ${count} kategorija`,
    "gradovi.playersDone": (count, total) => `${count} od ${total} igrača su završila`,
    "gradovi.doneStop": "Završio sam — stop",
    "gradovi.stopNote": "Stop zaključava tvoje odgovore i ubrzava rundu",
    "asocijacije.boardEyebrow": (round) => `Tabla ${round} · otvori polje`,
    "asocijacije.subtitle": "Manje otvaraš — više vrijedi",
    "asocijacije.yourScore": (points) => `Ti ${points}`,
    "asocijacije.finalWithPoints": (points) => `Konačno rješenje · ${points} poena`,
    "asocijacije.hostRevealNote": "Host može otvoriti tablu",
    "asocijacije.columns": "Kolone",
    "song.clipLabel": (seconds) => `klip ${seconds}s`,
    "song.titleMatched": "Naziv pogođen",
    "song.titlePending": "Naziv — još ne",
    "song.artistMatched": "Izvođač pogođen",
    "song.artistPending": "Izvođač — još ne",
    "song.firstCorrect": (name, bonus) => `Prvi tačan: ${name} +${bonus}`,
    "song.noFirstYet": "Još niko nije pogodio",
    "higherLower.phase.setup": "Priprema",
    "higherLower.phase.guessing": "Pogađanje",
    "higherLower.phase.reveal": "Otkrivanje",
    "higherLower.phase.finished": "Kraj",
    "higherLower.category.miks": "Miks",
    "higherLower.category.poznati": "Poznati",
    "higherLower.category.sport": "Sport",
    "higherLower.category.film-muzika": "Film i muzika",
    "higherLower.category.hrana": "Hrana i piće",
    "higherLower.category.brendovi-tech": "Brendovi i tech",
    "higherLower.category.mjesta": "Mjesta",
    "higherLower.category.historija-pojmovi": "Historija",
    "higherLower.category.regional": "Regija",
    "higherLower.setupTitle": "Veće ili Manje",
    "higherLower.playingTitle": "Šta se više gugla?",
    "higherLower.finishedTitle": "Kraj igre",
    "higherLower.rulesHint": "Sve se poredi po jednom broju: prosječne mjesečne Google pretrage. Svi pogađaju istu stavku u isto vrijeme — tačan odgovor donosi bodove, netačan odnosi život.",
    "higherLower.settings.category": "Kategorija",
    "higherLower.settings.rounds": "Runde",
    "higherLower.settings.lives": "Životi",
    "higherLower.settings.timer": "Vrijeme za odgovor",
    "higherLower.startGame": "Pokreni igru",
    "higherLower.waitingForSetup": "Čekamo da host pokrene igru...",
    "higherLower.searches": "mjesečnih pretraga",
    "higherLower.hidden": "? ? ?",
    "higherLower.question": (label) => `Ima li ${label} više ili manje pretraga?`,
    "higherLower.higher": "Više",
    "higherLower.lower": "Manje",
    "higherLower.round": (round, total) => `Runda ${round} / ${total}`,
    "higherLower.lockedIn": "Odgovor zaključan — čekamo ostale",
    "higherLower.youAreOut": "Nemaš više života — gledaš ostale",
    "higherLower.spectating": "Ušao/la si usred igre — igraš od sljedeće",
    "higherLower.correct": "Tačno!",
    "higherLower.wrong": "Netačno!",
    "higherLower.noAnswer": "Nisi stigao/la!",
    "higherLower.points": (points) => `+${points}`,
    "higherLower.answered": "odgovorio/la",
    "higherLower.out": "ispao/la",
    "higherLower.next": "Dalje",
    "higherLower.seeResults": "Rezultati",
    "higherLower.scoreboard": "Rezultati",
    "higherLower.winner": "Pobjednik",
    "higherLower.tie": "Neriješeno!",
    "higherLower.streak": (count) => `${count} zaredom`,
    "higherLower.bestStreak": (count) => `najbolji niz ${count}`,
    "higherLower.playAgain": "Igraj ponovo",
...
const gameCopies: Record<LanguagePreference, Record<GameId, GameCopy>> = {
  en: {
    ...
    "higher-lower": {
      ...
      tagline: "What gets googled more? Guess before you run out of lives.",
    },
  },
  bs: {
    imposteri: {
...
const gameDetails: Record<LanguagePreference, Record<GameId, GameDetails>> = {
  en: {
    ...
    "higher-lower": {
      rules: [
        "Every item is compared on one number: average monthly Google searches.",
        "Everyone sees the same pair and guesses higher or lower before the timer runs out.",
        "Right answers score points — faster answers and streaks score more. Wrong or no answer costs a life.",
        "Most points after the last round wins.",
      ],
      example:
        "Pizza has 55,000,000 monthly searches. Does Sushi have more or fewer? Lower — correct, +140!",
    },
  },
  bs: {
    imposteri: {
    ...
    "higher-lower": {
      rules: [
        "Svaka stavka se poredi po jednom broju: prosječne mjesečne Google pretrage.",
        "Svi vide isti par i pogađaju više ili manje prije nego što istekne vrijeme.",
        "Tačan odgovor donosi bodove — brži odgovor i niz tačnih donose više. Netačan ili nikakav odgovor odnosi život.",
        "Pobjeđuje ko ima najviše bodova nakon zadnje runde.",
      ],
      example:
        "Pizza ima 55.000.000 mjesečnih pretraga. Ima li Sushi više ili manje? Manje — tačno, +140!",
    },
  },
};
...
const localizedErrors: Record<LanguagePreference, Record<string, string>> = {
  ...
  bs: {
    ...
    "You already answered.": "Već si odgovorio/la.",
    "Not enough items for this category.": "Nema dovoljno pojmova za ovu kategoriju.",
    ...
    "No countdown is running.": "Odbrojavanje nije u toku.",
    "Countdown is still running.": "Odbrojavanje još traje.",
    "Still showing the answer.": "Rješenje se još prikazuje.",
